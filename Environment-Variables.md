...
| Environment Variable                                     | Server Argument               | Since  | Description                                                                                                                                                                                                                                                                                                                                                                |     Default |
| -------------------------------------------------------- | ----------------------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------: |
...
| `UPTIME_KUMA_SQLITE_SINGLE_CONNECTION`                   |                               | 2.3.2  | You can set it to `false` to enable multiple connections, but you may see `SQLITE_BUSY: database is locked` error. Read more: [#7289](https://github.com/louislam/uptime-kuma/issues/7289)                                                                                                                                                                                                |     `true` |
...
| Environment Variable                  | Since | Description                                                                     |
| ------------------------------------- | ----- | ------------------------------------------------------------------------------- |
...
The following Variables are also avaliable in the `*_FILE` variant, which can be usefull for using docker secrets. Other than that they are loaded from this path, they are identical.

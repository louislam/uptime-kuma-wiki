...
| `UPTIME_KUMA_SQLITE_SINGLE_CONNECTION`                   |                               | 2.3.2  | You normally don't need this, but it might help if you see `SQLITE_BUSY: database is locked` error. Read more: [#7289](https://github.com/louislam/uptime-kuma/issues/7289)                                                                                                                                                                                                |     `true` |

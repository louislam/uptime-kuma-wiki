...
class Database {
    ...
    static async connect(testMode = false, autoloadModels = true, noLog = false) {
        ...
        const poolCreateTimeout = parseInt(process.env.DB_CONNECTION_POOL_CREATE_TIMEOUT) || 30000;
        const poolDestroyTimeout = parseInt(process.env.DB_CONNECTION_POOL_DESTROY_TIMEOUT) || 5000;
        ...
        log.info("db", `MariaDB Pool Config - Min: ${poolMin}, Max: ${poolMax}, IdleTimeout: ${poolIdleTimeout}ms, AcquireTimeout: ${poolAcquireTimeout}ms, CreateTimeout: ${poolCreateTimeout}ms`);
